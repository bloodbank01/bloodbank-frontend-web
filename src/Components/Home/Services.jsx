                                    ...
                                    <div className="w-full h-full flex items-center">
                                        <div className="w-full">
                                            <div className="flex flex-col gap-3 items-center md:items-start">
                                                <span className='text-[90px] md:text-[100px] mb-0 pb-0 text-[#CECECE] font-bold' style={{ lineHeight: '1' }}>01</span>
                                                <span className='font-semibold text-[20px]'>Blood Donation</span>
                                    ...
                                    <div className="w-full h-full flex items-center">
                                        <div className="w-full">
                                            <div className="flex flex-col gap-3 items-center md:items-end">
                                                <span className='text-[90px] md:text-[100px] mb-0 pb-0 text-[#CECECE] font-bold' style={{ lineHeight: '1' }}>02</span>
                                                <span className='font-semibold text-[20px]'>Health Check</span>
                            ...
                            <div className="w-full flex flex-wrap">
                                ...
                                <div className="w-full md:w-1/2 md:ps-2 pt-8 md:pt-0">
                                    <div className="w-full h-full flex items-center">
                                        <div className="w-full">
                                            <div className="flex flex-col gap-3 items-center md:items-start">
                                                <span className='text-[90px] md:text-[100px] mb-0 pb-0 text-[#CECECE] font-bold' style={{ lineHeight: '1' }}>03</span>
                                                <span className='font-semibold text-[20px]'>Blood Bank</span>
